...
public class reserverlelivre extends AppCompatActivity {
    TextInputEditText textInputEditTextnumero,textInputEditTextnom,textInputEditTextprenom,textInputEditTextclasse,textInputEditTextdate,textInputEditTextdateretour;
    Button ajouter;
    Intent intent= new Intent(); Bundle bundle= intent.getBundleExtra("bundle");
    TextInputEditText titre=findViewById(R.id.titrelivre);
    EditText titrelivre=(EditText) findViewById(R.id.titrelivre);
    ...
    protected  void onCreate(Bundle savedInstanceState) {
        ...
        titrelivre.setText(bundle.getByte("titrelivre"));
        ...
        ajouter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                titrelivre = bundle.getString("titrelivre");
